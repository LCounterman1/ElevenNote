...
namespace ElevenNote.WebAPI
{
    public class SwaggerConfig
    {
        ...
        class AuthoTokenEndpointOperation : IDocumentFilter
        {
                    ...
                    .EnableSwagger(c =>
                        {
                            ...
                            c.DocumentFilter<AuthoTokenEndpointOperation>();
                    ...
                    .EnableSwaggerUi(c =>
                        {
                            ...
                            //
                            //c.InjectStylesheet(thisAssembly, "Swashbuckle.Dummy.SwaggerExtensions.testScript1.js");
